            ...
            <div className="mt-6 text-xl">
                <div className="bg-white mb-8 p-2">
                    ...
                    <ul className="text-lg list-disc list-inside mt-4 text-gray-600 space-y-1">
                        ...
                        <li>Spearheaded the end-to-end development of a Full Stack AI Solution, managing the lifecycle from initial design to deployment and implementing AI-powered automation to optimize task efficiency.</li>
                    </ul>
                </div>
                <div className="bg-white mb-8 p-2">
                    ...
                    <ul className="text-lg list-disc list-inside mt-4 text-gray-600 space-y-1">
                        ...
                        <li>Mastered the MERN stack to deliver scalable web applications.</li>
