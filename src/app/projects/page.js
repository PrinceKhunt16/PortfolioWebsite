...
const projects = [
    ...
    {
        title: "Revise in short - AI powered quiz, summry, etc. generator",
        ...
        <div className="p-10 text-gray-800">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2">
                {projects.map((project, index) => (
                    <div key={index} className="bg-gradient-to-br from-gray-100 to-gray-300 p-6 border-b border-r border-gray-300">
